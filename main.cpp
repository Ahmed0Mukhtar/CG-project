...
class Assignment08 : public BaseProject {
	...
	// This is where you change the starting position of the camera(center x= c+05, y= hieght, z= r+0.5)
	const int r = 14.5, c = 14.5;
	glm::vec3 CamPos = glm::vec3(c+0.5, 0.5, 2.0*r+1.0+10.0);
	float CamAlpha = 0.0f;
	float CamBeta = 0.0f;
	float Ar;
